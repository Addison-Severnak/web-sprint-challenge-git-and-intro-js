...
function addArtist(array, name, years, genre, nationality, bio) {
  const addArray = array.slice();
  const newArtist = {name, years, genre, nationality, bio};
  addArray.push(newArtist);
  return addArray;
}

console.log(addArtist(artists, 'Addison Severnak', '2000 - 11/2/2022', 'Web Design', 'American', 'I am currently working towards a career in Full Stack Development'));
